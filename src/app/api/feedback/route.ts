...
function buildPrompt(input: {
  ...
  return [
    ...
    "Required idea-opener check: check whether the learner naturally uses at least ONE instructor-preferred spoken opener anywhere in the answer. If at least one is already used naturally, set preferredOpener.status=good, set suggestedExpression to an empty string, and do not request, insert, or praise an additional opener. One suitable opener per answer is enough.",
    "Before recommending a missing opener, FIRST identify what the learner is trying to say, that idea's communicative function, and the most natural insertion point. Choose by function: positive feature/advantage = 'What's really nice is ...', 'The great thing is ...', or 'Another good thing is ...'; actual personal favorite/preference = 'What I like most is ...', 'What I really like is ...', 'One thing I really like is ...', or 'The best part is ...'; neutral major point = 'One thing I can say is ...'; special reason/personal significance = 'What makes it special is ...'; reason for liking something = 'One reason I like it is ...'; problem/disadvantage = 'The problem is ...'; explanation/important circumstance = 'The thing is ...'; genuine additional major idea = 'Another thing is ...'. Do not use 'What I like most is ...' as a generic starter when the learner is not expressing a favorite or preference.",
    "If none of the preferred openers appears, set preferredOpener.status=needs_work and recommend EXACTLY ONE contextually suitable opener. Its note should convey '답변 안에서 주요 아이디어를 시작할 때 이런 표현 중 하나를 사용하면 구조가 더 선명해집니다.' Never choose an opener that conflicts with the learner's meaning. suggestedExpression must be the exact, complete, contiguous English sentence inserted naturally into improvedAnswer, not a label or an ellipsis template.",
    "Idea-opener placement and style: the opener does NOT have to be the first answer sentence or immediately follow the introduction. Keep a direct answer first when that is more natural, then place the opener where its function genuinely begins; for example, 'I usually spend my staycations with my best friend, Hyunju. What's really nice is we have very similar interests.' Do not force 'What I like most is I can spend time with my best friend, Hyunju' when no favorite meaning is intended. Prefer the natural spoken pattern without automatically adding 'that': 'What's really nice is I can walk there', 'What I like most is it's very convenient', 'The thing is I don't have much time', and 'Another thing is the park is very close to my house.' Keep an existing 'that' only when there is a specific reason. Missing a preferred opener is not a grammar error and does not make otherwise strong logic or relevance weak. Do not insert it mechanically, alter the learner's meaning, require one in every paragraph, add several, rewrite the answer around it, make the response sound memorized, or turn it into an essay.",
    ...
    "Strict noun-number rule: NEVER give feedback or create a correction item based only on a noun's singular/plural form. Do not say '복수형이 더 자연스럽습니다', '여러 개를 의미하므로 복수형을 써야 합니다', 'tastes를 쓰면 더 자연스럽습니다', 'people이므로 ...', or 'restaurants처럼 복수형으로 ...'. Do not correct taste → tastes, restaurant → restaurants, friend → friends, experience → experiences, or the reverse merely to standardize noun number. In particular, 'We have very similar taste when it comes to movies and music' and 'similar taste' must not be flagged or changed to 'similar tastes' solely for singular/plural grammar. If noun number is the only issue, do not mention it, correct it, lower the evaluation, or rewrite it.",
    "Minor grammar rule: when meaning is clear, do not treat subject-verb agreement, countable/uncountable noun choice, articles, minor prepositions, or similar small slips as major '틀린 표현' items. Do not create a separate correction item for each one, describe the answer as grammatically weak, or make these the main weakness of an otherwise strong spoken response. Communication, content development, sentence completeness, and natural spoken English come first. The strict noun-number rule is stronger: noun singular/plural differences are not correction targets at all.",
    ...
    "Few-error summary rule: if there are almost no meaningful errors and the answer is easy to understand, clearly say '실수가 많지 않아서 크게 고칠 것은 없습니다. 전달력에는 전혀 문제가 없습니다.' If there are only 1–3 actual minor agreement or countable/uncountable slips, they may be summarized once without overstating them. Never include noun singular/plural differences in that summary, and never claim any slips occurred when they did not.",
    "Better-expression rule: when meaning is clear but a sentence is incomplete, underdeveloped, or awkward, frame one genuinely useful suggestion as optional improvement using Korean such as '더 자연스럽게 말하면...', '조금 더 완성된 문장으로 말하면...', or '이렇게 말하면 더 자연스럽습니다.' Do not call it a wrong expression unless it causes a meaningful grammar or meaning problem. This naturalness rule, grammar guidance, sentence-completeness guidance, accuracy guidance, and better-expression guidance must never be used as a back door to change noun singular/plural form when noun number is the only issue.",
    ...
    "- Preserve the learner's singular/plural noun forms when noun number is the only issue. Do not silently change 'similar taste' to 'similar tastes', or any singular noun to plural or plural noun to singular, merely for grammatical polishing or naturalness. Rewrite that form only when another important meaning or structural problem independently requires rewriting the sentence.",
